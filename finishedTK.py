...
class Main(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.wintext = self.theCanvas.create_text(400, 400, text="", font=("Consolas", 80), anchor="center")
    ...
    def doneclicked(self):
        ...
        self.drawBoard()
        if sum(self.piles) == 0:
            self.theCanvas.itemconfig(self.statustext, text="")
            self.theCanvas.itemconfig(self.wintext, text="You win!")
            self.gamestate = 2
        else:
            self.gamestate = 1
    ...
    def mouseMoved(self, e):
        ...
        self.movetext = self.theCanvas.create_text(20, 20, text=f"", anchor="nw")
    ...
    def mouseClicked(self, e):
        ...
        self.infotext = self.theCanvas.create_text(500, 100, text=f"Chose Column {column}", anchor="ne")
        ...
        if self.columnchosen != column:
            ...
            self.theCanvas.itemconfig(self.infotext, text="")
            self.numberchosen += 1
    ...
    def computerMove(self):
        ...
        if available_piles:
            ...
            self.theCanvas.itemconfig(self.infotext, text=f"")
            self.drawBoard()
            if sum(self.piles) == 0:
                self.theCanvas.itemconfig(self.statustext, text="")
                self.theCanvas.itemconfig(self.wintext, text="Computer wins!")
                self.gamestate = 2
            else:
                self.gamestate = 0
